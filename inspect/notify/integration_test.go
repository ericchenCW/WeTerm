...
func TestE2E_RealWorldFlapping(t *testing.T) {
	...
	stable := []AlertItem{
		...
		{Host: "", Field: "rabbitmq.bk_bkmonitorv3.celery_cron.stalled"},
		{Host: "", Field: "rabbitmq.prod_bk_itsm.default.stalled"},
		{Host: "", Field: "rabbitmq.prod_bk_monitorv3.celery.backlog"},
		{Host: "", Field: "rabbitmq.prod_cw_uac_saas.update_alarm_status.stalled"},
	}
	flapOut := AlertItem{Host: "", Field: "rabbitmq.prod_weops_saas.celery.stalled"}
